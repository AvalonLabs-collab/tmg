        ...
        initSlider: function (options) {
            $(".slider").each(function (i) {
                ...
                if (isSlider) {
                    ...
                    var currentMin = $(this).parent('div').find('input.j-min').val() || minVal,
                        currentMax = $(this).parent('div').find('input.j-max').val() || maxVal;
                    ...
                    $slider.slider({
                        ...
                        stop: function (event, ui) {
                            ...
                            if (wireId) {
                                ...
                                component.set('selectedMinPrice', ui.values[0]);
                                component.set('selectedMaxPrice', ui.values[1]);
                            }
                        }
                    });
                    $(".ui-slider-handle:first-of-type").append("<span class='min'NGN" + currentMin + "</span>");
                    $(".ui-slider-handle:last-of-type").append("<span class='max'>NGN" + currentMax + "</span>");
                }
            });
        },
