            ...
            <div class="row">
                <div class="col-md-5 col-md-offset-2 col-sm-6 col-xs-12">
                    <div class="b-welcome__text wow fadeInLeft" data-wow-delay="0.3s" data-wow-offset="100">
                        ...
                        @if( $companyBrief && $companyBrief['about_us'])
                          <p>
                            {{$companyBrief['about_us']}}
                          </p>
                          @else
                          <p>Curabitur libero. Donec facilisis velit eudsl est. Phasellus consequat. Aenean vita quam.
                            ...
                            mattis. Sed placerat leo nec.</p>
                        @endif

                          @if($companyBrief && $companyBrief['service_ensurance'])
                                 <ul>
                            @foreach($companyBrief['service_ensurance'] as $value )
